...
PARAMS_METHODS = {'POD': {'method_name': 'POD'},
                 ...
                 'DEEPONET': {'method_name': 'DEEPONET', 
                              'branch': {'layer_dims': [1, 8, 14, 11, 5], 'activations': ['relu', 'softplus', 'softplus'], 'device': 'cpu', 'seed': 123}, 
                              'trunk':{'layer_dims': [1, 7, 14, 11, 12, 5], 'activations': ['softplus', 'softplus', 'tanh', 'softplus'], 'device': 'cpu', 'seed': 123}
                             },
...
HYPERPARAMS_METHODS = {'POD': {'n_components': 5},
                       ...
                       'DEEPONET': {'lr': 0.00026889966844309896, 'epochs': 2000, 'optimizer': 'RMSprop', 'batch_size': 8549, 'device': 'cpu'},
                       'PINN': {'lr': 0.0005289943741212551, 'epochs': 10, 'optimizer': 'Adam', 'batch_size': 20000},
