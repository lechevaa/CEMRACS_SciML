...
params = {'solver': {'equation': 'Poisson', 'domain': [0, 1], 'D': 0., 'nx': nx,
          ...
          'method': {'layer_dims': [1, 20, 20, 20, 20, nx], 'activations': 'tanh', 'device': 'cuda', 'seed': 123,
                     'method_name': 'MLP'}}
...
hyperparameters = {'lr': 1e-3, 'epochs': 100, 'optimizer': 'Adam', 'batch_size': 64}
...
print(D_train.shape, U_train.shape)
